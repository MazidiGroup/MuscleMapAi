...
- PHASE 6 (exercise animations) HARD-PAUSED by design: licensing table delivered to user; NO assets downloaded. DEFERRED: cloud workout sync (needs DB schema approval), admin exercise export (parked per user).
