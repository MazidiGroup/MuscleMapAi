        ...
        <Pressable style={styles.card} testID="rest-timer" onPress={() => {}}>
          ...
          <View style={styles.presets}>
            {PRESETS.map((n) => (
              ...
              >
                <Text style={[styles.presetText, clock.total === n && { color: T.accent }]}>{n}s</Text>
              </TimerButton>
            ))}
          </View>
...
const makeStyles = (T: LegacyPalette) => StyleSheet.create({
  ...
  preset: { flex: 1, minHeight: 44, justifyContent: "center", borderRadius: 22, backgroundColor: T.surfaceHi, borderWidth: 1.5, borderColor: "transparent", alignItems: "center" },
  presetActive: { borderColor: T.accent },
  presetText: { color: T.text, fontSize: 14, fontWeight: "700" },
  actions: { flexDirection: "row", gap: 12, width: "100%" },
  actionBtn: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: T.surfaceHi, minHeight: 48, minWidth: 44, borderRadius: 22 },
