...
const makeStyles = (T: LegacyPalette) => StyleSheet.create({
  ...
  back: { position: "absolute", left: 14, width: 44, height: 44, borderRadius: 22, backgroundColor: "rgba(18,24,34,0.82)", alignItems: "center", justifyContent: "center" },
  panel: { flex: 1, backgroundColor: T.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, marginTop: -24, paddingHorizontal: 20, paddingTop: 10 },
  ...
  startBtn: { position: "absolute", left: 20, right: 20, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: T.accent, borderRadius: 22, paddingVertical: 15 },
  startText: { color: T.bg, fontSize: 16, fontWeight: "800" },
  prCard: { backgroundColor: T.surfaceHi, borderRadius: 22, padding: 14 },
